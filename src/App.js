...
import headimg from '../src/img/header.jpg';
...
function App() {
  ...
  return (
    ...
    <div className="App bg-slate-700 text-black">
      ...
      <div className='text-sm text-center text-white bg-slate-700 p-3'>Assignment by Saksham Sharma / sakshamsahore@gmail.com</div>
    </>
  );
}
